...
class App{
    ...
    public App() {
        ...
        TP5 runnable1 = new TP5("Thread 1", fim1, final1);
        TP5 runnable2 = new TP5("Thread 2", fim2, final2);
...
public class TP5 implements Runnable{
    ...
    public TP5(String nome, TextArea text, JLabel label){
        this.nome = nome;
        this.text = text;
        this.label = label;
    }
